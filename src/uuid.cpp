...
namespace
{
	...
	static void print(std::basic_ostream<Char>& os, const std::byte* id)
	{
		...
		write(byte_to_hex(id[0], chars::letter_A));
		write(byte_to_hex(id[1], chars::letter_A));
		write(byte_to_hex(id[2], chars::letter_A));
		write(byte_to_hex(id[3], chars::letter_A));
		write(chars::hyphen);
		write(byte_to_hex(id[4], chars::letter_A));
		write(byte_to_hex(id[5], chars::letter_A));
		write(chars::hyphen);
		write(byte_to_hex(id[6], chars::letter_A));
		write(byte_to_hex(id[7], chars::letter_A));
		write(chars::hyphen);
		write(byte_to_hex(id[8], chars::letter_A));
		write(byte_to_hex(id[9], chars::letter_A));
		write(chars::hyphen);
		write(byte_to_hex(id[10], chars::letter_A));
		write(byte_to_hex(id[11], chars::letter_A));
		write(byte_to_hex(id[12], chars::letter_A));
		write(byte_to_hex(id[13], chars::letter_A));
		write(byte_to_hex(id[14], chars::letter_A));
		write(byte_to_hex(id[15], chars::letter_A));
