...
namespace
{
	namespace sha1_utils
	{
		...
		static constexpr void MUU_VECTORCALL R0(const raw_block& bl,
												uint32_t v,
												uint32_t& w,
												uint32_t x,
												uint32_t y,
		...
		static constexpr void MUU_VECTORCALL R1(raw_block& bl,
												uint32_t v,
												uint32_t& w,
												uint32_t x,
												uint32_t y,
		...
		static constexpr void MUU_VECTORCALL R2(raw_block& bl,
												uint32_t v,
												uint32_t& w,
												uint32_t x,
												uint32_t y,
		...
		static constexpr void MUU_VECTORCALL R3(raw_block& bl,
												uint32_t v,
												uint32_t& w,
												uint32_t x,
												uint32_t y,
		...
		static constexpr void MUU_VECTORCALL R4(raw_block& bl,
												uint32_t v,
												uint32_t& w,
												uint32_t x,
												uint32_t y,
