...
/// \cond
#if defined(MUU_ORIENTED_BOUNDING_BOX_H) && defined(MUU_BOUNDING_SPHERE_H)                                             \
	&& !defined(MUU_ORIENTED_BOUNDING_BOX_BOUNDING_SPHERE_H)
#define MUU_ORIENTED_BOUNDING_BOX_BOUNDING_SPHERE_H
...
#endif // MUU_ORIENTED_BOUNDING_BOX_BOUNDING_SPHERE_H
/// \endcond
