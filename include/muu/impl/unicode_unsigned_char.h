...
//-----
// clang-format off
#ifndef MUU_UNICODE_UNSIGNED_CHAR_H
#define MUU_UNICODE_UNSIGNED_CHAR_H
...
namespace muu
{
	...
	{
		return c >= 0x30u && c <= 0x66u && (1ull << (static_cast<uint_least64_t>(c) - 0x30ull)) & 0x7E0000007E03FFull;
	}
