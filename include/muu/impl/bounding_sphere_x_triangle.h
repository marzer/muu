...
/// \cond
#if defined(MUU_BOUNDING_SPHERE_H) && defined(MUU_TRIANGLE_H) && !defined(MUU_BOUNDING_SPHERE_TRIANGLE_H)
#define MUU_BOUNDING_SPHERE_TRIANGLE_H
...
#endif // MUU_BOUNDING_SPHERE_TRIANGLE_H
/// \endcond
