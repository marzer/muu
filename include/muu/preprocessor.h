...
//======================================================================================================================
	...
	#define MUU_CPP							_MSVC_LANG
		...
		#define MUU_DISABLE_SPAM_WARNINGS	\
			...
			__pragma(warning(disable: 4866)) /* compiler may not enforce left-to-right evaluation order for call to blah */  \
...
#ifdef NDEBUG
	#define MUU_PURE_GETTER				MUU_NODISCARD						MUU_ATTR(pure)
	#define MUU_CONST_GETTER			MUU_NODISCARD						MUU_ATTR(const)
	#define MUU_PURE_INLINE_GETTER		MUU_NODISCARD	MUU_ALWAYS_INLINE	MUU_ATTR(pure)
	#define MUU_CONST_INLINE_GETTER		MUU_NODISCARD	MUU_ALWAYS_INLINE	MUU_ATTR(const)
#else
