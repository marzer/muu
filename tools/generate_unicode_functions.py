...
def write_header(folders, code_unit):
	...
	with open(header_path, 'w', encoding='utf-8', newline='\n') as header_file:
		...
		guard_name = rf'MUU_UNICODE_{code_unit.typename.upper()}_H'
		guard_name = re.sub(r'\s+', '_', guard_name)
		...
		both('//-----')
		both('// this file was generated by a script - do not modify it directly')
		both('//-----')
		both('// clang-format off')

		# header preamble
		h(rf'#ifndef {guard_name}')
		h(rf'#define {guard_name}')
		h('')
