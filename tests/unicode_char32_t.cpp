...
TEST_CASE("unicode - is_ascii (char32_t)")
{
	using namespace impl;
	static constexpr auto fn = static_cast<code_unit_func<char32_t>*>(is_ascii);
...
TEST_CASE("unicode - is_unicode (char32_t)")
{
	using namespace impl;
	static constexpr auto fn = static_cast<code_unit_func<char32_t>*>(is_unicode);
...
TEST_CASE("unicode - is_ascii_whitespace (char32_t)")
{
	...
	static constexpr code_unit_range<uint32_t> false_ranges[] = 
	{
		{ U'\0', U'\b' }, { U'\x0E', U'\x1F' }, { U'!', U'\xFF' },
	};
	for (const auto& r : false_ranges)
		REQUIRE(not_in(fn, r));
}

TEST_CASE("unicode - is_unicode_whitespace (char32_t)")
{
	using namespace impl;
	static constexpr auto fn = static_cast<code_unit_func<char32_t>*>(is_unicode_whitespace);
...
TEST_CASE("unicode - is_unicode_letter (char32_t)")
{
	using namespace impl;
	static constexpr auto fn = static_cast<code_unit_func<char32_t>*>(is_unicode_letter);
	...
	static constexpr code_unit_range<uint32_t> true_ranges[] = 
	{
		...
		{ U'\U00018D00', U'\U00018D08' }, { U'\U0001B000', U'\U0001B11E' }, { U'\U0001B150', U'\U0001B152' },
		...
		{ U'\U0001EEAB', U'\U0001EEBB' }, { U'\U00020000', U'\U0002A6DD' }, { U'\U0002A700', U'\U0002B734' },
	...
	static constexpr code_unit_range<uint32_t> false_ranges[] = 
	{
		...
		{ U'\U00018D09', U'\U0001AFFF' }, { U'\U0001B11F', U'\U0001B14F' }, { U'\U0001B153', U'\U0001B163' },
		...
		{ U'\U0002A6DE', U'\U0002A6FF' }, { U'\U0002B735', U'\U0002B73F' }, { U'\U0002B81E', U'\U0002B81F' },
		{ U'\U0002CEA2', U'\U0002CEAF' }, { U'\U0002EBE1', U'\U0002F7FF' }, { U'\U0002FA1E', U'\U0002FFFF' },
		{ U'\U0003134B', 0x00110009u },
	};
	for (const auto& r : false_ranges)
		REQUIRE(not_in(fn, r));
...
TEST_CASE("unicode - is_unicode_number (char32_t)")
{
	using namespace impl;
	static constexpr auto fn = static_cast<code_unit_func<char32_t>*>(is_unicode_number);
...
TEST_CASE("unicode - is_unicode_hyphen (char32_t)")
{
	using namespace impl;
	static constexpr auto fn = static_cast<code_unit_func<char32_t>*>(is_unicode_hyphen);
...
TEST_CASE("unicode - is_uppercase (char32_t)")
{
	using namespace impl;
	static constexpr auto fn = static_cast<code_unit_func<char32_t>*>(is_uppercase);
 
	// values which should return true
	static constexpr code_unit_range<uint32_t> true_ranges[] = 
	{
		{ U'A', U'Z' }, { U'\xC0', U'\xD6' }, { U'\xD8', U'\xDE' },
		{ U'\u0178', U'\u0179' }, { U'\u0181', U'\u0182' }, { U'\u0186', U'\u0187' },
		{ U'\u0189', U'\u018B' }, { U'\u018E', U'\u0191' }, { U'\u0193', U'\u0194' },
		{ U'\u0196', U'\u0198' }, { U'\u019C', U'\u019D' }, { U'\u019F', U'\u01A0' },
		{ U'\u01A6', U'\u01A7' }, { U'\u01AE', U'\u01AF' }, { U'\u01B1', U'\u01B3' },
		{ U'\u01B7', U'\u01B8' }, { U'\u01F6', U'\u01F8' }, { U'\u023A', U'\u023B' },
		{ U'\u023D', U'\u023E' }, { U'\u0243', U'\u0246' }, { U'\u0388', U'\u038A' },
		{ U'\u038E', U'\u038F' }, { U'\u0391', U'\u03A1' }, { U'\u03A3', U'\u03AB' },
		{ U'\u03D2', U'\u03D4' }, { U'\u03F9', U'\u03FA' }, { U'\u03FD', U'\u042F' },
		{ U'\u04C0', U'\u04C1' }, { U'\u0531', U'\u0556' }, { U'\u10A0', U'\u10C5' },
		{ U'\u13A0', U'\u13F5' }, { U'\u1C90', U'\u1CBA' }, { U'\u1CBD', U'\u1CBF' },
		{ U'\u1F08', U'\u1F0F' }, { U'\u1F18', U'\u1F1D' }, { U'\u1F28', U'\u1F2F' },
		{ U'\u1F38', U'\u1F3F' }, { U'\u1F48', U'\u1F4D' }, { U'\u1F68', U'\u1F6F' },
		{ U'\u1FB8', U'\u1FBB' }, { U'\u1FC8', U'\u1FCB' }, { U'\u1FD8', U'\u1FDB' },
		{ U'\u1FE8', U'\u1FEC' }, { U'\u1FF8', U'\u1FFB' }, { U'\u210B', U'\u210D' },
		{ U'\u2110', U'\u2112' }, { U'\u2119', U'\u211D' }, { U'\u212A', U'\u212D' },
		{ U'\u2130', U'\u2133' }, { U'\u213E', U'\u213F' }, { U'\u2160', U'\u216F' },
		{ U'\u24B6', U'\u24CF' }, { U'\u2C00', U'\u2C2E' }, { U'\u2C62', U'\u2C64' },
		{ U'\u2C6D', U'\u2C70' }, { U'\u2C7E', U'\u2C80' }, { U'\uA77D', U'\uA77E' },
	...
	static constexpr code_unit_range<uint32_t> false_ranges[] = 
	{
		{ U'\0', U'@' }, { U'[', U'\xBF' }, { U'\xDF', U'\xFF' },
		{ U'\u0137', U'\u0138' }, { U'\u0148', U'\u0149' }, { U'\u017E', U'\u0180' },
		{ U'\u018C', U'\u018D' }, { U'\u0199', U'\u019B' }, { U'\u01AA', U'\u01AB' },
		{ U'\u01B9', U'\u01BB' }, { U'\u01BD', U'\u01C3' }, { U'\u01C5', U'\u01C6' },
		{ U'\u01C8', U'\u01C9' }, { U'\u01CB', U'\u01CC' }, { U'\u01DC', U'\u01DD' },
		{ U'\u01EF', U'\u01F0' }, { U'\u01F2', U'\u01F3' }, { U'\u0233', U'\u0239' },
		{ U'\u023F', U'\u0240' }, { U'\u024F', U'\u036F' }, { U'\u0373', U'\u0375' },
		{ U'\u0377', U'\u037E' }, { U'\u0380', U'\u0385' }, { U'\u03AC', U'\u03CE' },
		{ U'\u03D0', U'\u03D1' }, { U'\u03D5', U'\u03D7' }, { U'\u03EF', U'\u03F3' },
		{ U'\u03F5', U'\u03F6' }, { U'\u03FB', U'\u03FC' }, { U'\u0430', U'\u045F' },
		{ U'\u0481', U'\u0489' }, { U'\u04CE', U'\u04CF' }, { U'\u052F', U'\u0530' },
		{ U'\u0557', U'\u109F' }, { U'\u10C8', U'\u10CC' }, { U'\u10CE', U'\u139F' },
		{ U'\u13F6', U'\u1C8F' }, { U'\u1CBB', U'\u1CBC' }, { U'\u1CC0', U'\u1DFF' },
		{ U'\u1E95', U'\u1E9D' }, { U'\u1EFF', U'\u1F07' }, { U'\u1F10', U'\u1F17' },
		{ U'\u1F1E', U'\u1F27' }, { U'\u1F30', U'\u1F37' }, { U'\u1F40', U'\u1F47' },
		{ U'\u1F4E', U'\u1F58' }, { U'\u1F60', U'\u1F67' }, { U'\u1F70', U'\u1FB7' },
		{ U'\u1FBC', U'\u1FC7' }, { U'\u1FCC', U'\u1FD7' }, { U'\u1FDC', U'\u1FE7' },
		{ U'\u1FED', U'\u1FF7' }, { U'\u1FFC', U'\u2101' }, { U'\u2103', U'\u2106' },
		{ U'\u2108', U'\u210A' }, { U'\u210E', U'\u210F' }, { U'\u2113', U'\u2114' },
		{ U'\u2116', U'\u2118' }, { U'\u211E', U'\u2123' }, { U'\u212E', U'\u212F' },
		{ U'\u2134', U'\u213D' }, { U'\u2140', U'\u2144' }, { U'\u2146', U'\u215F' },
		{ U'\u2170', U'\u2182' }, { U'\u2184', U'\u24B5' }, { U'\u24D0', U'\u2BFF' },
		{ U'\u2C2F', U'\u2C5F' }, { U'\u2C65', U'\u2C66' }, { U'\u2C73', U'\u2C74' },
		{ U'\u2C76', U'\u2C7D' }, { U'\u2CE3', U'\u2CEA' }, { U'\u2CEE', U'\u2CF1' },
		{ U'\u2CF3', U'\uA63F' }, { U'\uA66D', U'\uA67F' }, { U'\uA69B', U'\uA721' },
		{ U'\uA72F', U'\uA731' }, { U'\uA76F', U'\uA778' }, { U'\uA787', U'\uA78A' },
		{ U'\uA78E', U'\uA78F' }, { U'\uA793', U'\uA795' }, { U'\uA7BF', U'\uA7C1' },
		{ U'\uA7CA', U'\uA7F4' }, { U'\uA7F6', U'\uFF20' }, { U'\uFF3B', 0x00110009u },
	};
	for (const auto& r : false_ranges)
		REQUIRE(not_in(fn, r));
	static constexpr char32_t false_values[] = 
...
TEST_CASE("unicode - is_lowercase (char32_t)")
{
	using namespace impl;
	static constexpr auto fn = static_cast<code_unit_func<char32_t>*>(is_lowercase);
 
	// values which should return true
	static constexpr code_unit_range<uint32_t> true_ranges[] = 
	{
		{ U'a', U'z' }, { U'\xDF', U'\xF6' }, { U'\xF8', U'\xFF' },
		{ U'\u0137', U'\u0138' }, { U'\u0148', U'\u0149' }, { U'\u017E', U'\u0180' },
		{ U'\u018C', U'\u018D' }, { U'\u0199', U'\u019B' }, { U'\u01AA', U'\u01AB' },
		{ U'\u01B9', U'\u01BA' }, { U'\u01BD', U'\u01BF' }, { U'\u01DC', U'\u01DD' },
		{ U'\u01EF', U'\u01F0' }, { U'\u0233', U'\u0239' }, { U'\u023F', U'\u0240' },
		{ U'\u024F', U'\u0293' }, { U'\u0295', U'\u02B8' }, { U'\u02C0', U'\u02C1' },
		{ U'\u02E0', U'\u02E4' }, { U'\u037A', U'\u037D' }, { U'\u03AC', U'\u03CE' },
		{ U'\u03D0', U'\u03D1' }, { U'\u03D5', U'\u03D7' }, { U'\u03EF', U'\u03F3' },
		{ U'\u03FB', U'\u03FC' }, { U'\u0430', U'\u045F' }, { U'\u04CE', U'\u04CF' },
		{ U'\u0560', U'\u0588' }, { U'\u10D0', U'\u10FA' }, { U'\u10FD', U'\u10FF' },
		{ U'\u13F8', U'\u13FD' }, { U'\u1C80', U'\u1C88' }, { U'\u1D00', U'\u1DBF' },
		{ U'\u1E95', U'\u1E9D' }, { U'\u1EFF', U'\u1F07' }, { U'\u1F10', U'\u1F15' },
		{ U'\u1F20', U'\u1F27' }, { U'\u1F30', U'\u1F37' }, { U'\u1F40', U'\u1F45' },
		{ U'\u1F50', U'\u1F57' }, { U'\u1F60', U'\u1F67' }, { U'\u1F70', U'\u1F7D' },
		{ U'\u1F80', U'\u1F87' }, { U'\u1F90', U'\u1F97' }, { U'\u1FA0', U'\u1FA7' },
		{ U'\u1FB0', U'\u1FB4' }, { U'\u1FB6', U'\u1FB7' }, { U'\u1FC2', U'\u1FC4' },
		{ U'\u1FC6', U'\u1FC7' }, { U'\u1FD0', U'\u1FD3' }, { U'\u1FD6', U'\u1FD7' },
		{ U'\u1FE0', U'\u1FE7' }, { U'\u1FF2', U'\u1FF4' }, { U'\u1FF6', U'\u1FF7' },
		{ U'\u2090', U'\u209C' }, { U'\u210E', U'\u210F' }, { U'\u213C', U'\u213D' },
		{ U'\u2146', U'\u2149' }, { U'\u2170', U'\u217F' }, { U'\u24D0', U'\u24E9' },
		{ U'\u2C30', U'\u2C5E' }, { U'\u2C65', U'\u2C66' }, { U'\u2C73', U'\u2C74' },
		{ U'\u2C76', U'\u2C7D' }, { U'\u2CE3', U'\u2CE4' }, { U'\u2D00', U'\u2D25' },
		{ U'\uA69B', U'\uA69D' }, { U'\uA72F', U'\uA731' }, { U'\uA76F', U'\uA778' },
		{ U'\uA793', U'\uA795' }, { U'\uA7F8', U'\uA7FA' }, { U'\uAB30', U'\uAB5A' },
		{ U'\uAB5C', U'\uAB68' }, { U'\uAB70', U'\uABBF' }, { U'\uFB00', U'\uFB06' },
		{ U'\uFB13', U'\uFB17' }, { U'\uFF41', U'\uFF5A' },
	};
	for (const auto& r : true_ranges)
	{
	...
	static constexpr code_unit_range<uint32_t> false_ranges[] = 
	{
		{ U'\0', U'`' }, { U'{', U'\xA9' }, { U'\xAB', U'\xB4' },
		{ U'\xB6', U'\xB9' }, { U'\xBB', U'\xDE' }, { U'\u0178', U'\u0179' },
		{ U'\u0181', U'\u0182' }, { U'\u0186', U'\u0187' }, { U'\u0189', U'\u018B' },
		{ U'\u018E', U'\u0191' }, { U'\u0193', U'\u0194' }, { U'\u0196', U'\u0198' },
		{ U'\u019C', U'\u019D' }, { U'\u019F', U'\u01A0' }, { U'\u01A6', U'\u01A7' },
		{ U'\u01AE', U'\u01AF' }, { U'\u01B1', U'\u01B3' }, { U'\u01B7', U'\u01B8' },
		{ U'\u01BB', U'\u01BC' }, { U'\u01C0', U'\u01C5' }, { U'\u01C7', U'\u01C8' },
		{ U'\u01CA', U'\u01CB' }, { U'\u01F1', U'\u01F2' }, { U'\u01F6', U'\u01F8' },
		{ U'\u023A', U'\u023B' }, { U'\u023D', U'\u023E' }, { U'\u0243', U'\u0246' },
		{ U'\u02B9', U'\u02BF' }, { U'\u02C2', U'\u02DF' }, { U'\u02E5', U'\u0344' },
		{ U'\u0346', U'\u0370' }, { U'\u0374', U'\u0376' }, { U'\u0378', U'\u0379' },
		{ U'\u037E', U'\u038F' }, { U'\u0391', U'\u03AB' }, { U'\u03D2', U'\u03D4' },
		{ U'\u03F6', U'\u03F7' }, { U'\u03F9', U'\u03FA' }, { U'\u03FD', U'\u042F' },
		{ U'\u0482', U'\u048A' }, { U'\u04C0', U'\u04C1' }, { U'\u0530', U'\u055F' },
		{ U'\u0589', U'\u10CF' }, { U'\u10FB', U'\u10FC' }, { U'\u1100', U'\u13F7' },
		{ U'\u13FE', U'\u1C7F' }, { U'\u1C89', U'\u1CFF' }, { U'\u1DC0', U'\u1E00' },
		{ U'\u1F08', U'\u1F0F' }, { U'\u1F16', U'\u1F1F' }, { U'\u1F28', U'\u1F2F' },
